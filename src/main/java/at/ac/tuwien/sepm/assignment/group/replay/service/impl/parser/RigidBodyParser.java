...
public class RigidBodyParser {
    ...
    RigidBodyInformation parseRigidBodyInformation(int frameId, int actorUpdateId, double frameTime, boolean gamePaused) {
        ...
        Map<String, Object> position = ctx.read("$.Frames[" + frameId + "].ActorUpdates[" + actorUpdateId + "]." + rigidBodyPosition);
        Map<String, Object> rotation = ctx.read("$.Frames[" + frameId + "].ActorUpdates[" + actorUpdateId + "]." + rigidBodyRotation);
        Map<String, Object> linearVelocity = ctx.read("$.Frames[" + frameId + "].ActorUpdates[" + actorUpdateId + "]." + rigidBodyLinearVelocity);
        Map<String, Object> angularVelocity = ctx.read("$.Frames[" + frameId + "].ActorUpdates[" + actorUpdateId + "]." + rigidBodyAngularVelocity);
    ...
    /**
     * Generates a Vector3D from Map generated by JsonPath.
    ...
    /**
     * Generates a Quaternion from Map generated by JsonPath.
